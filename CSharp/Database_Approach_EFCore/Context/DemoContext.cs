...
namespace Database_Approach_EFCore.Context;
...
public partial class DemoContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=demo;Username=postgres;Password=12345");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Area1).HasName("areas_pkey");
        ...
        {
            entity.HasKey(e => new { e.Employeeid, e.Skill }).HasName("employeeskills_pkey");
            ...
            entity.HasOne(d => d.SkillNavigation).WithMany(p => p.Employeeskills)
                .HasForeignKey(d => d.Skill)
                .HasConstraintName("fk_emp_skill_skill");
        });
        ...
        {
            entity.HasKey(e => e.Username).HasName("newusers_pkey");
        ...
        {
            entity.HasKey(e => e.Skill1).HasName("skills_pkey");
            ...
            entity.Property(e => e.Skill1)
                .HasMaxLength(30)
                .HasColumnName("skill");
            entity.Property(e => e.Skilldescription).HasColumnName("skilldescription");
        });
