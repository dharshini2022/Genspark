namespace Delegates_Extension_Method
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(checkAccountWithAccNum(
                new CurrentAccount() { AccountNumber = "12344", NameOnAccount = "Bamu", Balance = 54321.5f, DateOfBirth = new DateTime(1999, 12, 12), Email = "Bamu@gmail.com", Phone = "4321098765" }));
        }
    }
}
