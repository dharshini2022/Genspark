...
namespace BankingAPI.Contexts
{
    public class BankingContext : DbContext
    {
        ...
        public DbSet<FilterRequest> FilterRequest {get; set;}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FilterRequest>().HasNoKey();
            modelBuilder.Entity<FilterRequest>(entity =>
            {
                entity.Property(x => x.FromDate).HasColumnType("timestamp without time zone");
                entity.Property(x => x.ToDate).HasColumnType("timestamp without time zone");
            });
