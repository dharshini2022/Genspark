...
namespace BusBookingSystem.Controllers
{
    ...
    public class CustomerController : AppControllerBase  // OOP: Inherits GetCurrentUserId() from AppControllerBase
    {
        ...
        public async Task<IActionResult> BlockSeats([FromBody] SeatBlockRequestDto dto)
        {
            try
            {
                var result = await _svc.BlockSeatsAsync(GetCurrentUserId(), dto);
        ...
        public async Task<IActionResult> CreateBooking([FromBody] CreateBookingDto dto)
        {
            try
            {
                var result = await _svc.CreateBookingAsync(GetCurrentUserId(), dto);
                return Ok(result);
            }
        ...
        {
            var result = await _svc.GetMyBookingsAsync(GetCurrentUserId());
            return Ok(result);
        }
        ...
        public async Task<IActionResult> GetBooking(int id)
        {
            try
            {
                var result = await _svc.GetBookingDetailAsync(GetCurrentUserId(), id);
                return Ok(result);
            }
            catch (InvalidOperationException ex)
            {
        ...
        public async Task<IActionResult> CancelBooking(int id, [FromBody] CancelBookingDto dto)
        {
            try
            {
                var result = await _svc.CancelBookingAsync(GetCurrentUserId(), id, dto);
                return Ok(result);
            }
            catch (InvalidOperationException ex)
            {
        ...
        public async Task<IActionResult> Pay([FromBody] PaymentRequestDto dto)
        {
            try
            {
                var result = await _svc.ProcessPaymentAsync(GetCurrentUserId(), dto);
                return Ok(result);
            }
            catch (InvalidOperationException ex)
            {
        ...
        {
            var result = await _svc.GetProfileAsync(GetCurrentUserId());
            return Ok(result);
        }
        ...
        {
            var result = await _svc.UpdateProfileAsync(GetCurrentUserId(), dto);
            return Ok(result);
        }
    }
}
